...
async function testTradeAccess() {
  console.log('🔍 Testing trade access after fix...');
  ...
  try {
    ...
    console.log('Result without user ID:', trade1 ? '✅ Found (trade is public)' : '❌ Not found (trade is private)');
    ...
    console.log('Result with correct user ID:', trade2 ? '✅ Found' : '❌ Not found');
    ...
    console.log('Result with wrong user ID:', trade3 ? '❌ Found (security issue!)' : '✅ Not found (correct)');
