...
class ImageProcessor {
  ...
  async saveImage(processedImage, uploadsDir) {
    try {
      ...
      // Filenames are generated by processImage/processAvatar; refuse anything
      // that is not a bare filename so a write can never leave uploadsDir.
      const filename = processedImage.filename;
      if (typeof filename !== 'string' || filename !== path.basename(filename) || filename.startsWith('.')) {
