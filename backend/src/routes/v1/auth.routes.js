...
// Mirror of authLimiter in ../auth.routes.js — v1 endpoints are equally exposed (mobile surface).
...
router.post('/test-email', authLimiter, authController.sendTestEmail);
