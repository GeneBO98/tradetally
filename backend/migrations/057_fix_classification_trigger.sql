...
CREATE TABLE IF NOT EXISTS strategy_classification_history (
    ...
    INDEX idx_strategy_classification_trade_id (trade_id),
    INDEX idx_strategy_classification_user_id (user_id),
    INDEX idx_strategy_classification_created_at (created_at)
);
