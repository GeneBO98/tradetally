...
-- This table stores default commission and fee rates per broker for each user
...
-- Add comments
COMMENT ON TABLE broker_fee_settings IS 'Stores default commission and fee rates per broker for each user';
