  ...
  <div class="content-wrapper py-8">
    ...
    <div class="space-y-8">
      ...
      <template v-if="activeTab === 'trading'">
        ...
        <div class="card mb-8">
          <div class="card-body">
            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Trading Accounts</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
              Manage your brokerage accounts to associate trades with specific accounts during import.
              Accounts help you track performance across different brokers and account types.
            </p>
            <router-link to="/accounts" class="btn-primary inline-flex items-center">
