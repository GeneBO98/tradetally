<template>
    <div class="content-wrapper py-8">
        ...
        <div class="space-y-8">
                    ...
                    <form @submit.prevent="handleImport" class="space-y-6">
                        <div>
                            ...
                            >
                                ...
                                <option value="tradingview_performance">
                                    TradingView Performance
                                </option>
                                <optgroup
                                    v-if="customMappings.length > 0"
                            ...
                            >
                                ...
                                structure, or use Auto-Detect. If your format
                                isn't recognized, you'll be prompted to create a
                            ...
                            >
                                ...
                                >
                                    {{ account.name
                                        ...
                                        account.identifier
                                            ? ` (${redactAccountId(account.identifier)})`
                                            : ""
                                    }}{{
                                        account.broker
                                            ? ` - ${formatBrokerName(account.broker)}`
                                            : ""
                                    }}
                                </option>
                                <option value="none">
                                    None (different broker/account)
                                </option>
                            </select>
                            <p
                                class="mt-1 text-sm text-gray-500 dark:text-gray-400"
                            >
                                Select a trading account to associate with this
                                import, or choose "None" if importing from a
                                different broker.
                                <router-link
                                    to="/accounts"
                        ...
                        <div class="flex justify-end">
                            <button
                                type="submit"
                                :disabled="
                                    !selectedFile || !selectedBroker || loading
                                "
                                class="btn-primary"
                            >
            ...
            <div v-if="customMappings.length > 0" class="card">
                <div class="card-body">
                    ...
                    <div v-show="showCustomMappings" class="space-y-3">
                        ...
                        >
                            Manage your custom CSV importers. These appear in
                            the broker format dropdown for quick reuse.
                        </p>
                        ...
                        >
                            <div class="flex-1 min-w-0">
                                ...
                                >
                                    <span v-if="mapping.use_count > 0"
                                        >Used {{ mapping.use_count }} time{{
                                            mapping.use_count !== 1 ? "s" : ""
                                        }}</span
                                    >
                                    <span v-if="mapping.last_used_at"
                                        >Last used
                                        {{
                                ...
                                >
                                    ...
                                    {{ mapping.entry_price_column }}
                                    <span v-if="mapping.side_column"
                                        >, {{ mapping.side_column }}</span
                                    >
                                </div>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div v-show="showFormats" class="space-y-6">
                        <div>
                            ...
                            >
                                Use this format if your broker isn't listed or
                                for custom CSV files. Supports comma, semicolon,
                                or tab separators.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Symbol,Date,Entry Price,Exit
                                Price,Quantity,Side,Commission,Fees<br />
                            ...
                            >
                                <strong>Alternative column names:</strong>
                                Symbol/symbol, Date/Trade Date, Entry Price/Buy
                                Price/Price, Exit Price/Sell Price,
                                Quantity/Shares/Size, Side/Direction/Type,
                                Commission/Fees
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export from Lightspeed's "Reports" > "Trade
                                Blotter" section as CSV.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Symbol,Trade Date,Price,Qty,Side,Commission
                                Amount,Execution Time,Trade Number<br />
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> Symbol, Trade
                                Date, Price, Qty, Side (B/S), Commission Amount.
                                Optional: Execution Time, Buy/Sell, Security
                                Type, fee columns (FeeSEC, FeeMF, etc.)
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export from ThinkorSwim's "Account Statement"
                                section. Only processes trade (TRD) records.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                DATE,TIME,TYPE,DESCRIPTION,Commissions &
                                Fees,Misc Fees<br />
                                01/15/2024,09:30:00,TRD,"BOT +100 AAPL
                                @150.25",1.00,0.00<br />
                                01/15/2024,10:45:00,TRD,"SOLD -100 AAPL
                                @155.50",1.00,0.00
                            </div>
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                ...
                                TYPE (must be "TRD"), DESCRIPTION (BOT/SOLD
                                format). Optional: Commissions & Fees, Misc Fees
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export from IBKR's "Reports" > "Trade
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> Symbol,
                                DateTime, Quantity (positive=buy,
                                negative=sell), Price. Optional: Commission,
                                Fees
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export from Webull's "Orders" > "Options Orders"
                                history. Supports options trading with automatic
                                roundtrip trade detection.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Name,Symbol,Side,Status,Filled,Total
                                Qty,Price,Avg Price,Time-in-Force,Placed
                                Time,Filled Time<br />
                                SPY251114C00672000,SPY251114C00672000,Buy,Filled,3,3,1.82,1.82,DAY,11/14/2025
                                11:10:02 EST,11/14/2025 11:10:02 EST<br />
                                SPY251114C00672000,SPY251114C00672000,Sell,Filled,3,3,2.87,2.87,DAY,11/14/2025
                                11:31:56 EST,11/14/2025 11:31:56 EST
                            </div>
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> Symbol, Side,
                                Status, Filled, Avg Price, Filled Time.
                                Automatically parses option symbols (format:
                                SPY251114C00672000).
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Symbol,Transaction Date,Transaction
                                Type,Quantity,Price,Commission,Fees<br />
                            ...
                            >
                                <strong>Required columns:</strong> Symbol,
                                Transaction Date, Transaction Type (Buy/Sell),
                                Quantity, Price. Optional: Commission, Fees
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Supports both completed trades export and
                                transaction history. Tab-separated files are
                            ...
                            >
                                ...
                                Symbol,Opened Date,Closed Date,Quantity,Cost Per
                                Share,Proceeds Per Share,Gain/Loss ($)<br />
                                AAPL,01/15/2024,01/15/2024,100,150.25,155.50,525.00<br /><br />
                                <strong>Transaction History:</strong><br />
                                Date,Action,Symbol,Description,Quantity,Price,Fees
                                & Comm,Amount<br />
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Supports both formats:</strong>
                                Completed trades with P&L or individual
                                transactions. Auto-detects format and delimiter.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export from ThinkorSwim's PaperMoney platform.
                                Filled orders are treated as actual executed
                                trades for analysis and tracking.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Filled Orders<br />
                                ,,Exec Time,Spread,Side,Qty,Pos
                                Effect,Symbol,Exp,Strike,Type,Price,Net
                                Price,Price Improvement,Order Type<br />
                                ,,9/19/25 13:24:32,STOCK,SELL,-100,TO
                                CLOSE,FATN,,,STOCK,9.86,9.86,.00,MKT<br />
                                ,,9/19/25 13:22:37,STOCK,BUY,+100,TO
                                OPEN,FATN,,,STOCK,9.63,9.63,.00,MKT
                            </div>
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> Exec Time,
                                Side, Qty, Symbol, Price. Filled orders are
                                processed as real trades and grouped into
                                round-trip positions with P&L calculations.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export transaction history from TradeStation.
                                Supports both equity and options trades with
                                detailed fee breakdown.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                Account,T/D,S/D,Currency,Type,Side,Symbol,Qty,Price,Exec
                                Time,Comm,SEC,TAF,NSCC,Nasdaq<br />
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> T/D, S/D,
                                Side, Symbol, Qty, Price, Exec Time. All fee
                                columns are automatically summed.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p
                                class="text-sm text-gray-500 dark:text-gray-400 mb-2"
                            >
                                Export performance data from TradingView.
                                Contains completed trades with calculated P&L.
                            </p>
                            <div
                                class="bg-gray-50 dark:bg-gray-800 rounded-md p-3 text-xs font-mono overflow-x-auto"
                            >
                                ...
                                TSLA,fill_003,fill_004,50,225.75,220.50,-262.50,1736954400000,1736965200000,2h
                                40m
                            </div>
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-2"
                            >
                                <strong>Required columns:</strong> symbol, qty,
                                buyPrice, sellPrice, boughtTimestamp,
                                soldTimestamp. Timestamps are Unix milliseconds.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div v-if="importHistory.length > 0" class="card">
                <div class="card-body">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <label
                                class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 cursor-pointer select-none"
                            >
                                <input
                    ...
                    <div class="space-y-3">
                        <div
                            ...
                            :class="
                                selectedImportIds.has(importLog.id)
                        ...
                        >
                            <div class="flex items-center space-x-3">
                                <input
                                    ...
                                    "
                                    @change="
                                        toggleImportSelection(importLog.id)
                                    "
                                    class="rounded border-gray-300 dark:border-gray-600 text-primary-600 focus:ring-primary-500"
                                />
                                <div>
                                ...
                                <div class="text-right">
                                    <div class="flex items-center space-x-2">
                                        <span
                                            ...
                                            :class="
                                                getStatusClass(importLog.status)
                                            "
                                        >
                                            {{
                                    ...
                                    <p
                                        v-if="importLog.status === 'completed'"
                                        class="text-sm text-gray-500 dark:text-gray-400"
                                    >
                                        {{ importLog.trades_imported }} imported
                                        <span
                                            v-if="importLog.trades_failed > 0"
                                        >
                                            •
                    ...
                    <div v-if="pagination.hasMore" class="mt-4 text-center">
                        ...
                        >
                            Load More ({{
                                pagination.total - importHistory.length
                            }}
                            remaining)
                        </button>
                    </div>
            ...
            >
                <div
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-11/12 max-w-4xl h-3/4 flex flex-col"
                >
                    <!-- Header -->
                    <div
                        ...
                        <div class="w-1/3 pr-4 flex flex-col">
                            ...
                            <div v-else class="flex flex-col h-full">
                                ...
                                >
                                    ...
                                    >
                                        {{
                                            logFilesPagination.showAll
                                                ? "All log files"
                                                : "Today's log files"
                                        }}
                                        ({{ logFiles.length }} of
                                        {{ logFilesPagination.total }})
                                    </span>
                                    <button
                                ...
                                <div
                                    class="flex-1 overflow-y-auto space-y-2 pr-2 border border-gray-200 dark:border-gray-600 rounded-lg p-3"
                                >
                                    <button
                                    ...
                                    <!-- Load More Button -->
                                    <div
                                        v-if="logFilesPagination.hasMore"
                        ...
                        <div class="w-2/3 pl-4 flex flex-col">
                            ...
                            >
                                    ...
                                    <div>
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                of
                                                {{ logPagination.total }} lines
                                                <span v-if="logSearchQuery"
                                                    >(filtered)</span
                                                >
                                            </span>
                                            <span
                                                v-if="
                                                    !logPagination.showAll &&
                                                    logPagination.filteredOut >
                                                        0
                                                "
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        >
                                            {{
                                                logPagination.showAll
                                                    ? "Show Last 24h"
                                                    : `Show All (${logPagination.totalAllLines} lines)`
                                            }}
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div
                                        v-if="logSearchQuery && searchResults"
                                        class="mt-2 text-sm text-gray-600 dark:text-gray-400"
                                    >
                                        Found
                                        {{ searchResults.matchCount }} matches
                                        in {{ searchResults.lineCount }} lines
                                    </div>
                                </div>

                                <div
                                    class="flex-1 bg-gray-100 dark:bg-gray-900 p-4 rounded-lg overflow-y-auto"
                                >
                                    <div
                                        v-if="logSearchQuery && !logContent"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    >
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                Some brokers export trades with CUSIP codes
                                instead of ticker symbols. Manage how these
                                codes are mapped to ticker symbols for better
                        ...
                        <div class="flex items-center gap-2 flex-shrink-0">
                            ...
                            >
                                ...
                                <span class="hidden sm:inline"
                                    >{{ unmappedCusipsCount }} Unmapped</span
                                >
                    ...
                    <div
                        v-if="unmappedCusipsCount > 0"
                        class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-3 mb-6"
                    >
                        <div class="flex items-center">
                            ...
                            <div class="text-sm">
                                ...
                                >
                                    {{ unmappedCusipsCount }} unmapped CUSIP{{
                                        unmappedCusipsCount !== 1 ? "s" : ""
                                    }}
                                    found in your trades
                                </span>
                                <p
                                    class="text-yellow-700 dark:text-yellow-300 mt-1"
                                >
                                    These trades may not appear when filtering
                                    by ticker symbol. Click "Unmapped" to
                                    resolve them.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label for="cusip" class="label"
                                        >CUSIP (9 characters)</label
                                    >
                                    <input
                                        id="cusip"
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div>
                                    <label for="lookupCusip" class="label"
                                        >CUSIP to Lookup</label
                                    >
                                    <input
                                        id="lookupCusip"
                                ...
                                <button
                                    @click="lookupCusip"
                                    :disabled="
                                        !lookupForm.cusip || cusipLoading
                                    "
                                    class="btn-primary w-full"
                                >
                                    <span v-if="cusipLoading"
                                        >Looking up...</span
                                    >
            ...
            >
                <div class="mt-3 text-center">
                    ...
                    >
                        {{
                            bulkDeleteIds
                                ? `Delete ${bulkDeleteIds.length} Imports`
                                : "Delete Import"
                        }}
                    </h3>
                    <div class="mt-2 px-7 py-3">
                        ...
                        <div
                            v-if="deleteImportData && !bulkDeleteIds"
                            class="mt-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-md text-left"
                        >
                            <p
                                class="text-sm font-medium text-gray-900 dark:text-white"
                            >
                                {{ deleteImportData.file_name }}
                            </p>
                            <p
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                {{ deleteImportData.trades_imported }} trades
                                will be deleted
                            </p>
                        </div>
                        <!-- Bulk delete details -->
                        <div
                            v-if="bulkDeleteIds"
                            class="mt-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-md text-left max-h-48 overflow-y-auto"
                        >
                            <div
                                v-for="imp in bulkDeleteDetails"
                                :key="imp.id"
                                class="text-sm py-1 border-b border-gray-200 dark:border-gray-600 last:border-0"
                            >
                                <p
                                    class="font-medium text-gray-900 dark:text-white"
                                >
                                ...
                                >
                                    ...
                                    {{ imp.trades_imported }} trades
                                </p>
                            </div>
                            <p
                                class="text-sm font-medium text-gray-900 dark:text-white mt-2 pt-2 border-t border-gray-300 dark:border-gray-500"
                            >
                                Total: {{ bulkDeleteTotalTrades }} trades will
                                be deleted
                            </p>
                        </div>
                        <p
                            class="text-xs text-red-600 dark:text-red-400 mt-2 font-medium"
                        >
                    ...
                    <div class="flex gap-3 justify-center mt-4">
                        ...
                        <button
                            ...
                            :disabled="deleting || bulkDeleting"
                        >
                            <span v-if="deleting || bulkDeleting"
                                >Deleting...</span
                            >
        ...
        >
            ...
            >
                ...
                <div class="mt-5 sm:mt-6 space-y-3">
                    ...
                    <button
                        v-if="
                            !hasUsedTrial && (!trialInfo || !trialInfo.active)
                        "
                        type="button"
                ...
                <div class="mt-3 text-center">
                    ...
                    <div class="mt-2 px-7 py-3">
                        ...
                        >
                            <p
                                class="text-sm font-medium text-gray-900 dark:text-white"
                            >
                                {{ mappingToDelete.mapping_name }}
                            </p>
                            <p
                                v-if="mappingToDelete.description"
                                class="text-xs text-gray-500 dark:text-gray-400 mt-1"
                            >
                            ...
                            <p
                                class="text-xs text-gray-500 dark:text-gray-400 mt-1"
                            >
                                <span v-if="mappingToDelete.use_count > 0"
                                    >Used {{ mappingToDelete.use_count }} time{{
                                        mappingToDelete.use_count !== 1
                                            ? "s"
                                            : ""
                                    }}</span
                                >
                    ...
                    <div class="flex gap-3 justify-center mt-4">
                        ...
                        <button
                            ...
                            :disabled="deletingMappingId !== null"
                        >
                            <span v-if="deletingMappingId !== null"
                                >Deleting...</span
                            >
                            <span v-else>Delete</span>
                        </button>
...
function detectKnownFormat(headers) {
    ...
    if (
        headersStr.includes("date") &&
        headersStr.includes("time") &&
        headersStr.includes("type") &&
        headersStr.includes("ref #") &&
        headersStr.includes("description")
    ) {
        return true;
    }
    ...
    if (
        headersStr.includes("symbol") &&
        headersStr.includes("side") &&
        headersStr.includes("fill price") &&
        headersStr.includes("status") &&
        headersStr.includes("order id") &&
        headersStr.includes("leverage")
    ) {
        return true;
    }
    ...
    if (
        (headersStr.includes("trade number") ||
            headersStr.includes("sequence number")) &&
        (headersStr.includes("execution time") ||
            headersStr.includes("raw exec")) &&
        (headersStr.includes("commission amount") ||
            headersStr.includes("feesec"))
    ) {
        return true;
    }
    ...
    if (
        headersStr.includes("exec time") &&
        headersStr.includes("pos effect") &&
    ...
    if (
        (headersStr.includes("opened date") &&
            headersStr.includes("closed date") &&
            headersStr.includes("gain/loss")) ||
        (headersStr.includes("symbol") &&
            headersStr.includes("quantity") &&
            headersStr.includes("cost per share") &&
            headersStr.includes("proceeds per share"))
    ) {
        return true;
    }
    if (
        headersStr.includes("action") &&
        headersStr.includes("fees & comm") &&
        headersStr.includes("date") &&
        headersStr.includes("symbol") &&
        headersStr.includes("description")
    ) {
    ...
    if (
        headersStr.includes("underlyingsymbol") &&
        headersStr.includes("strike") &&
        headersStr.includes("expiry") &&
        headersStr.includes("put/call") &&
        headersStr.includes("multiplier") &&
        headersStr.includes("buy/sell")
    ) {
        return true;
    }
    if (
    ...
    // E*TRADE detection
    if (
        headersStr.includes("transaction date") &&
        headersStr.includes("transaction type") &&
    ...
    // ProjectX detection
    if (
        headersStr.includes("contractname") &&
        headersStr.includes("enteredat") &&
        headersStr.includes("exitedat") &&
    ...
    // Tradovate detection
    if (
        headersStr.includes("b/s") &&
        headersStr.includes("contract") &&
        headersStr.includes("product") &&
        headersStr.includes("fill time") &&
        (headersStr.includes("avgprice") ||
            headersStr.includes("avg fill price")) &&
    ...
    // Questrade detection
    if (
        headersStr.includes("fill qty") &&
        headersStr.includes("fill price") &&
        headersStr.includes("exec time") &&
        headersStr.includes("option") &&
    ...
    if (
        headersStr.includes("account") &&
        headersStr.includes("t/d") &&
        headersStr.includes("s/d") &&
        headersStr.includes("exec time") &&
        (headersStr.includes("gross proceeds") ||
            headersStr.includes("net proceeds"))
    ) {
        return true;
    }
    ...
    if (
        headersStr.includes("buyfillid") &&
        headersStr.includes("sellfillid") &&
        headersStr.includes("boughttimestamp") &&
        headersStr.includes("soldtimestamp") &&
        headersStr.includes("pnl")
    ) {
        return true;
    }
    ...
    const hasSymbol = lowerHeaders.some(
        (h) =>
            h.includes("symbol") || h.includes("ticker") || h.includes("stock"),
    );
    const hasSide = lowerHeaders.some(
        (h) =>
            h.includes("side") ||
    ...
    const hasPrice = lowerHeaders.some(
        (h) => h.includes("price") || h.includes("fill"),
    );
...
async function handleImport() {
    ...
    if (requiresAccountSelection.value && selectedAccountId.value === null) {
        error.value =
            'Please select a trading account or choose "None" for this import';
        return;
    }

    // Convert "none" to null for the API
    const accountIdToSend =
        selectedAccountId.value === "none" ? null : selectedAccountId.value;
    ...
    try {
        ...
        if (userTier === "free" && tradeCount > FREE_TIER_IMPORT_LIMIT) {
            console.log(
                `[IMPORT] Free tier user attempting to import ${tradeCount} trades (limit: ${FREE_TIER_IMPORT_LIMIT})`,
            );
            loading.value = false;
        ...
        console.log(
            `[IMPORT] Tier check passed (${userTier}), proceeding with format detection`,
        );
        ...
        if (broker !== "auto" && broker !== "generic" && !mappingId) {
            ...
            try {
                ...
                const validationResult = await api.post(
                ...
                if (validation.mismatch) {
                    console.log(
                        `[IMPORT] Broker mismatch detected: selected=${validation.selectedBroker}, detected=${validation.detectedBroker}`,
                    );
                    loading.value = false;
                ...
                console.warn(
                    "[IMPORT] Validation check failed, proceeding with import:",
        ...
        if (
            ...
            if (!formatDetected) {
                console.log(
                    "[IMPORT] Unknown format - showing column mapping modal",
                );
                loading.value = false;
            ...
            console.log(
                `[IMPORT] Known format detected, proceeding with import`,
            );
        }
        ...
        showSuccess(
            "Import Started",
            `Import has been queued. Import ID: ${result.importId}`,
        );
        ...
        if (
            errorMessage.includes("CURRENCY_REQUIRES_PRO") ||
            errorMessage.includes("Currency conversion is a Pro feature")
        ) {
            const message =
                errorMessage.split(":")[1] ||
                "Currency conversion is a Pro feature. Please upgrade to Pro to import trades with non-USD currencies.";
            showCurrencyProModal.value = true;
            currencyProMessage.value = message;
        }
        // Check if this is a batch import limit error
        else if (
            errorMessage.includes("trades per import") ||
            errorMessage.includes("batch import")
        ) {
            showCurrencyProModal.value = true;
        ...
        // Check if this is an unsupported format or missing columns error
            ...
            try {
                ...
                if (headers.length > 0) {
                    ...
                    error.value =
                        "Could not parse CSV headers. Please check your file format.";
...
async function handleUseBrokerDetected(detectedBroker) {
    console.log(
        `[IMPORT] User chose to use detected broker: ${detectedBroker}`,
    );
    showBrokerMismatchModal.value = false;
...
async function handleKeepBrokerSelected(selectedBrokerValue) {
    console.log(
        `[IMPORT] User chose to keep selected broker: ${selectedBrokerValue}`,
    );
    showBrokerMismatchModal.value = false;
    ...
    try {
        ...
        if (
            requiresAccountSelection.value &&
            selectedAccountId.value !== null &&
            selectedAccountId.value !== "none"
        ) {
...
async function confirmDelete() {
    ...
    if (bulkDeleteIds.value) {
        ...
        try {
            ...
            showSuccess(
                "Imports Deleted",
                `${response.data.deletedImports} imports and ${response.data.deletedTrades} trades deleted`,
            );
            ...
            showError(
                "Delete Failed",
                error.response?.data?.error || "Failed to delete imports",
            );
        } finally {
    ...
    try {
        ...
        showSuccess(
            "Import Deleted",
            "Import and associated trades have been deleted",
        );
        ...
        showError(
            "Delete Failed",
            error.response?.data?.error || "Failed to delete import",
        );
    } finally {
...
function toggleSelectAll() {
    if (selectedImportIds.value.size === importHistory.value.length) {
        ...
        selectedImportIds.value = new Set(
            importHistory.value.map((imp) => imp.id),
        );
    }
}
...
function bulkDeleteImports() {
    ...
    const details = importHistory.value.filter((imp) =>
        selectedImportIds.value.has(imp.id),
    );
    const totalTrades = details.reduce(
        (sum, imp) => sum + (imp.trades_imported || 0),
        0,
    );
...
const highlightedLogContent = computed(() => {
    ...
    try {
        const query = logSearchQuery.value.replace(
            /[.*+?^${}()|[\]\\]/g,
            "\\$&",
        );
        const regex = new RegExp(`(${query})`, "gi");
        return logContent.value.replace(
            regex,
...
async function addCusipMapping() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            showSuccess(
                "CUSIP Mapping Added",
                `${cusipForm.value.cusip} → ${cusipForm.value.ticker}${result.tradesUpdated ? ` (${result.tradesUpdated} trades updated)` : ""}`,
            );
            ...
            showError(
                "Add Failed",
                error.error || "Failed to add CUSIP mapping",
            );
        }
    } catch (error) {
...
async function lookupCusip() {
    ...
    try {
        ...
        const response = await fetch(
            `/api/cusip-mappings?search=${lookupForm.value.cusip.toUpperCase()}&limit=1`,
            {
                headers: {
                    Authorization: `Bearer ${tradesStore.token || localStorage.getItem("token")}`,
                },
...
function deleteCusipMapping(cusip) {
    showDangerConfirmation(
        "Delete CUSIP Mapping",
        `Are you sure you want to delete the mapping for ${cusip}?`,
        async () => {
            cusipLoading.value = true;
            ...
            try {
                ...
                if (response.ok) {
                    showSuccess(
                        "CUSIP Mapping Deleted",
                        `Mapping for ${cusip} has been deleted`,
                    );
                    await fetchUnmappedCusipsCount();
                } else {
                    const error = await response.json();
                    showError(
                        "Delete Failed",
                        error.error || "Failed to delete CUSIP mapping",
                    );
                }
            } catch (error) {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (newCount !== oldCount) {
                console.log(
                    `[CUSIP POLLING] Count updated: ${oldCount} → ${newCount}`,
                );
            } else {
...
function handleResolutionStarted(data) {
    console.log(
        `[CUSIP POLLING] Resolution started for ${data.total} CUSIPs - starting polling every 3 seconds`,
    );
    ...
    const pollInterval = setInterval(async () => {
        pollCount++;
        console.log(
            `[CUSIP POLLING] Poll #${pollCount} - checking for updates...`,
        );
        ...
        if (unmappedCusipsCount.value === 0) {
            ...
            console.log(
                `[CUSIP POLLING] Polling stopped after ${pollCount} polls - all CUSIPs resolved!`,
            );
        }
    }, 3000);
    ...
    setTimeout(
        () => {
            clearInterval(pollInterval);
            console.log(
                `[CUSIP POLLING] Polling stopped after 5 minutes timeout (${pollCount} polls completed)`,
            );
        },
        5 * 60 * 1000,
    );
    ...
    const poll = async () => {
        try {
            ...
            if (status === "completed" || status === "failed") {
                ...
                if (
                    tradesImported === 0 &&
                    knownBrokers.includes(selectedBroker.value)
                ) {
                    showImportantWarning(
                        "No Trades Imported",
                        `The import completed but no trades were found. This usually means the file format doesn't match what the ${selectedBroker.value} parser expects. Please check the documentation for the correct export format.`,
                        {
                            confirmText: "OK",
                            linkUrl:
                                "https://docs.tradetally.io/usage/importing-trades/#supported-brokers",
                ...
                if (status === "completed") {
                    ...
                    try {
                        ...
                        const beforeMin =
                            beforeStats.level_progress?.current_level_min_xp ||
                            0;
                        const beforeNext =
                            beforeStats.level_progress?.next_level_min_xp ||
                            100;
                        ...
                        const newAchievements =
                            checkRes.data?.data?.newAchievements || [];
                        ...
                        if (count > 0) {
                            ...
                            const afterXP =
                                afterStats.experience_points || beforeXP;
                            const afterLevel = afterStats.level || beforeLevel;
                            const afterMin =
                                afterStats.level_progress
                                    ?.current_level_min_xp || beforeMin;
                            const afterNext =
...
async function fetchCustomMappings() {
    try {
        ...
        if (response.data.success) {
            ...
            console.log(
                "[CSV MAPPINGS] Loaded custom mappings:",
                customMappings.value.length,
            );
        }
    } catch (err) {
...
function confirmDeleteMapping(mapping) {
    ...
    console.log(
        "[DELETE MAPPING] showDeleteMappingModal set to:",
        showDeleteMappingModal.value,
    );
    console.log(
        "[DELETE MAPPING] mappingToDelete set to:",
...
async function deleteMapping() {
    ...
    console.log(
        "[DELETE MAPPING] mappingToDelete.value:",
        mappingToDelete.value,
    );
    ...
    console.log(
        "[DELETE MAPPING] Deleting mapping:",
        mapping.id,
        mapping.mapping_name,
    );
    ...
    try {
        console.log(
            "[DELETE MAPPING] Making API call to /csv-mappings/" + mapping.id,
        );
        ...
        if (response.data.success) {
            showSuccess(
                "Importer Deleted",
                `"${mapping.mapping_name}" has been deleted`,
            );
            ...
            if (selectedBroker.value === `custom:${mapping.id}`) {
                console.log(
                    "[DELETE MAPPING] Deleted mapping was selected, resetting to auto",
                );
                selectedBroker.value = "auto";
            }
        } else {
        ...
        showError(
            "Delete Failed",
            err.response?.data?.error || "Failed to delete importer",
        );
    } finally {
...
async function startTrial() {
    try {
        ...
        console.log(
            "[IMPORT] Current user tier before trial:",
            authStore.user?.tier,
        );
        ...
        if (response.data.success) {
            console.log(
                "[IMPORT] Trial started successfully, refreshing user data...",
            );
            ...
            console.log(
                "[IMPORT] authStore.user after fetchUser:",
                authStore.user,
            );
            console.log(
                "[IMPORT] User tier after fetchUser:",
                authStore.user?.tier,
            );
            ...
            try {
                ...
                console.log(
                    "[IMPORT] Subscription check response:",
                    subResponse.data,
                );
                const trialActive = subResponse.data.data?.trial?.active;
                console.log(
                    "[IMPORT] Trial active from subscription check:",
                    trialActive,
                );
            } catch (subErr) {
                console.log(
                    "[IMPORT] Could not verify subscription:",
                    subErr.message,
                );
            }
            ...
            showSuccessModal(
                "Trial Activated",
                "14-day Pro trial started! You now have unlimited batch imports.",
                {
                    ...
                    onConfirm: () => {
                        ...
                        if (fileToImport) {
                            console.log(
                                "[IMPORT] Re-triggering import with file:",
                                fileToImport.name,
                            );
    ...
    (ids) => {
        if (selectAllCheckbox.value) {
            const isIndeterminate =
                ids.size > 0 && ids.size < importHistory.value.length;
