  ...
  <div class="card">
    <div class="card-body">
      ...
      <div v-else class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-center justify-between">
              <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Get reminders about trade-related actions and important trade lifecycle events
                </p>
              </div>
              <div class="ml-4">
                <label class="relative inline-flex items-center cursor-pointer">
        ...
        <div>
          <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-4 flex items-center">
            <MdiIcon :icon="earthIcon" :size="16" class="mr-2 text-green-500" />
            Market Notifications
          </h4>
          <div class="space-y-4">
            <div class="flex items-center justify-between">
              <div class="flex-1">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Receive notifications about general market events, economic news, and market-wide updates
                </p>
              </div>
              <div class="ml-4">
                <label class="relative inline-flex items-center cursor-pointer">
                  <input
                    type="checkbox"
                    v-model="preferences.notify_market_events"
                    @change="updatePreference('notify_market_events')"
                    class="sr-only peer"
                    :disabled="updating"
                  />
                  <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary-600"></div>
...
import { mdiBell, mdiAlert, mdiChartLine, mdiBellAlert, mdiEarth, mdiCheck, mdiInformation } from '@mdi/js'
