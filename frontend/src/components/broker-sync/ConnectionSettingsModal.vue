      ...
      <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg">
        ...
        <div class="p-6 space-y-6">
          ...
          <div v-if="form.autoSyncEnabled">
            <label for="syncFrequency" class="label">Sync Frequency</label>
            <select
              id="syncFrequency"
          ...
          <div class="pt-4 border-t border-gray-200 dark:border-gray-700">
            <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-3">Connection Status</h4>
            <dl class="space-y-2 text-sm">
              ...
              <div v-if="connection.nextScheduledSync" class="flex justify-between">
                <dt class="text-gray-500 dark:text-gray-400">Next Sync</dt>
                <dd class="text-gray-900 dark:text-white">
